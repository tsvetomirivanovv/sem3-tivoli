                    ...
                    if (response.success) {
                        ...
                        response.shifts.forEach(function (shiftData) {
                            ...
                            if (!response1.success) {
                                ...
                                shifts += "                       <a class='edit_shift_glyphicon' href='#'>" +
                    ...
                    if (response.success) {
                        ...
                        response.accounts.forEach(function (accountData) {
                            ...
                            if (!response1.success) {
                                ...
                                accounts += '       <a href="edit-profile.php?username=' + accountData['username'] + '"><span class="glyphicon glyphicon-edit updateButtonPos"></span></a>' +
                                    '           </td>' +
                                    '</tr>';
                            }
