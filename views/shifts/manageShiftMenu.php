    ...
    <div class="jumbotron jumboFix">
        ...
        <div>
            ...
            <ul class="nav nav-pills" role="tablist">
                ...
                <li role="presentation"><a href="#my_Shifts" aria-controls="my_Shifts" role="tab" data-toggle="tab">My shifts</a></li>
                <li role="presentation"><a href="#create_Shift" aria-controls="create_Shift" role="tab" data-toggle="tab">Create shift</a></li>
                <li role="presentation"><a href="#my_Offer" aria-controls="my_Offer" role="tab" data-toggle="tab">My offer</a></li>
            </ul>
